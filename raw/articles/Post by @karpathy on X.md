...
> > 
> > > **Goss Gowtham 𝕏 @Goss\_Gowtham** · [2026-04-02](https://x.com/Goss_Gowtham/status/2039835272939237694)
> > > 
> > > Damn! We've Codex, Windsurf, AntiGravity, Claude etc., it's often confusing to have skills, plugins and other unexplored features unless we know how to use it. Similarities and efficient usages will be really helpful in your style.
> > > 
> > > Got a response from the legend himself ❤️‍🔥
...
> > 
> > > **Krishna Tammireddy @tammireddy** · [2026-04-02](https://x.com/tammireddy/status/2039816467798245825)
> > > 
> > > Ha - your raw/ metaphor was too good not to use. The product gap is real though. Someone has to build it for the non-dev world.
...
> **Nico Cserepy @nicocserepy** · [2026-05-21](https://x.com/nicocserepy/status/2057537171813175746)
> 
> ive been getting good results having the system maintain a minimal set of yes/no decisions i made that fully describe my telos
> 
> ive been dumping all the data i generate into an s3 bucket, loading into s3 tables, then sorting those so i always have the right context to make yes no